...
BINDINGS: list[tuple[str, str, str]] = [
    ...
    ("ZNetScene", "public List<GameObject> m_prefabs", "additive shell registration (§3.5, M3R)"),
    ("ZNetScene", "private readonly Dictionary<int, GameObject> m_namedPrefabs", "additive shell hash registration (§3.5, M3R)"),
    ("ZNetScene", "public void Destroy(GameObject go)", "network despawn/cleanup (§3.5)"),
    ("ZNetScene", "public GameObject FindInstance(ZDOID id)", "owned-instance lookup for despawn/reconcile (§3.5, M3R)"),
    ...
    ("CraftingStation", "public string m_name", "required additive station blueprint name (§3.5, M3R)"),
    ("CraftingStation", "public float m_useDistance", "required additive station blueprint use distance (§3.5, M3R)"),
    ("ZNetView", "public ZDO GetZDO()", "owned-instance ZDOID handle (§3.5, M3R)"),
    ("ZNetView", "public void Destroy()", "network-aware owned despawn (§3.5, M3R)"),
    ("ZNetView", "public void ClaimOwnership()", "owner-claim before despawn (§3.5, M3R)"),
    ("ZDOMan", "public ZDO GetZDO(ZDOID id)", "owned-ZDO reconcile/despawn fallback (§3.5, M3R)"),
    ("ZDOMan", "public void DestroyZDO(ZDO zdo)", "network-replicated ZDO despawn (§3.5, M3R)"),
    ("ZDOMan", "public void FindSectorObjects(Vector2i sector, int area, int distantArea, List<ZDO> sectorObjects, List<ZDO> distantSectorObjects = null)", "bounded marker discovery (§3.5, M3R)"),
    ("ZDOMan", "public static long GetSessionID()", "server ownership claim fallback (§3.5, M3R)"),
    ("ZoneSystem", "public static Vector2i GetZone(Vector3 point)", "bounded marker-discovery sector (§3.5, M3R)"),
    ("ZDO", "public int GetPrefab()", "marker-discovery prefab allowlist (§3.5, M3R)"),
    ("ZDO", "public Vector3 GetPosition()", "exact marker-discovery radius (§3.5, M3R)"),
    ("ZDO", "public void Set(string name, string value)", "durable ownership marker write (§3.5, M3R)"),
    ("ZDO", "public string GetString(string name, string defaultValue = \"\")", "durable ownership marker read (§3.5, M3R)"),
    ("ZDO", "public void SetOwner(long uid)", "server ownership claim fallback (§3.5, M3R)"),
