...
param(
    ...
    [string]$ModpackUrl    = 'https://github.com/PolyphonyRequiem/SBPRValheimMods/releases/download/v0.2.16-playtest/SBPR-Trailborne-Modpack-v0.2.16.zip',
    [string]$ExpectedSha256= '5528490feb8a942e57b673fa34e8f18f87e20f1551c923d8d05bbcf70ca85165',
