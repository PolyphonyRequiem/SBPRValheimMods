...
| research/ | SUBFOLDER: feasibility spikes/investigations serving design-tier ideas (point-in-time, historical). See research/index.md. Currently: stone-of-drought-phase0-spike.md (card t_5baa81c9 — logical-repel hook built 0W/0E, visible-divot verdict OBSERVATION-PENDING) |
