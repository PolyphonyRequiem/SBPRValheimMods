...
| 5 | Offering and personal AP/Facet-Credit purchase ownership/provenance | completed personal node becomes Offered and an eligible Attuned buys it with PersonalAP; Facet-Credit payment debits the matching Facet Credit; one debit + one purchase record | `NiflheimPurchaseTierTests.cs:277,490,302` |
