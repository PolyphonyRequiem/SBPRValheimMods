...
| Tree revocation | Atomic reset/refund contract; Facet Credit issued; Permanent Effects/Keys survive (spec FR-021) | Group cannot be a backdoor to dodge or share the revocation contract |
