...
| T022-ARRANGE-SWEEP.md | current | The shipped SWEEP arrange phase: convergent entry sweep of prior-run credentials and their ownership-provenance sidecars, marker-only process safety (B1), and what the next-entry guarantee does and does not bound |
...
- Remaining arrange work: #457 (runner cutover). It maps to a phase in
  `T022-ARRANGE-SPEC.md` §4; VERIFY (#456) has shipped — see §4.1 — and SWEEP (#455) has
  shipped, see §4.2.
