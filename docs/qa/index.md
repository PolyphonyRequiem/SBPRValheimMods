...
- Remaining arrange work: #451 (unified staging), #455 (sweep + idempotency), #456
  (post-arrange verification + readiness report), #457 (runner cutover). Each maps to a
  phase in `T022-ARRANGE-SPEC.md` §4.
