...
**Build:** SBPR Trailborne 0.2.40 (current `main`, ahead of `v0.2.40-playtest`)
...
`Loading [SBPR Trailborne 0.2.40]` and `Harmony patches applied.`
...
Code commits touching `src/**/*.cs` since **v0.2.40-playtest**: **6**
