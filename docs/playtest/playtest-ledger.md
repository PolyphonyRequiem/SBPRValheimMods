...
- Design/blocked cards not yet built (no test item until they ship): equipable-icon
  transparent-bg (t_b9a111ca, PR #201 open).
  ([M] name-hint under the disc, t_26bba85b, now ships its code → PENDING item 3 above;
  biome indicators on the disc/modal, t_304076fa, now ships its code in this PR → moved to
  PENDING item 4 above; both verify after merge.)
